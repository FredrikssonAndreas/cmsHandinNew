...
namespace cmsHandin.Controllers
{
    public class HomeSurfaceController : SurfaceController
    {
        ...
        public async Task<IActionResult> HandleSubmit(HomePageFormModel form)
        {
            ...
            string htmlContent = $@"
                                    ...
                                    <img src='https://cmshandin.azurewebsites.net/media/0vaf2kn4/onatrixlogotype.svg
                                       ' alt='Företagslogotyp' style='width: 150px;' /> <!-- Publik URL till logotypen -->
                                    </div>
